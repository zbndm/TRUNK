...
export class GUIProcessManager {
    static async process(settings, cancellationToken) {
    ...
    static async processKmeansClustering(imgData, tabsOutput, ctx, settings, cancellationToken) {
    ...
    static async processFacetReduction(facetResult, tabsOutput, settings, colormapResult, cancellationToken) {
    ...
    static async processFacetBorderTracing(tabsOutput, facetResult, cancellationToken) {
    ...
    static async processFacetBorderSegmentation(facetResult, tabsOutput, settings, cancellationToken) {
    ...
    static async processFacetLabelPlacement(facetResult, cBorderSegment, tabsOutput, cancellationToken) {
     ...
     */
    static async createSVG(facetResult, colorsByIndex, sizeMultiplier, fill, stroke, addColorLabels, fontSize = 50, fontColor = "black", onUpdate = null) {
