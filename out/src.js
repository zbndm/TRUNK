...
define("gui", ["require", "exports", "common", "guiprocessmanager", "settings"], function (require, exports, common_8, guiprocessmanager_1, settings_2) {
    ...
    function updatePaitingImageSVG() {
        if ($("#svgContainer svg").length > 0) {
    ...
    exports.updatePaitingImageSVG = updatePaitingImageSVG;
        ...
        $("#btnProcess").click(function () {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    $('#btnProcess').html('Loading...');
                    yield gui_2.process();
                }
                catch (err) {
                    $('#btnProcess').attr('disabled', false);
                    $('#btnProcess').html('Generate the Paiting Image');
                    alert("Error: " + err);
                }
            });
        });
